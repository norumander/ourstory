    ...
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-gray-600">{community.description}</p>
        ...
        <div className="flex gap-3">
          ...
          <Link href={`/fundraiser/new?communityId=${community.id}`}>
            <Button variant="outline">Start a Fundraiser</Button>
          </Link>
        </div>
      </div>
      ...
      <section>
        ...
        {community.fundraisers.length === 0 ? (
          <p className="text-sm text-gray-500">No fundraisers yet.</p>
        ) : (
