      ...
      <Card className="w-full">
        ...
        <CardContent>
              ...
              <div className="mb-2 grid grid-cols-4 gap-2">
                {[10, 25, 50, 100].map((preset) => (
                  <button
                    ...
                    className="rounded-lg border border-warm-300 py-2 text-sm font-medium text-warm-700 hover:border-primary-500 hover:bg-primary-50 hover:text-primary-700"
                  >
                    ${preset}
                  </button>
                ))}
          ...
          <Link
            ...
            className="mt-4 block text-center text-sm text-warm-500 hover:text-warm-700"
          >
            ← Back to fundraiser
          </Link>
        </CardContent>
